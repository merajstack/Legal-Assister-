...
export const STATE_DISTRICTS: Record<string, string[]> = {
  "Andhra Pradesh": [
    ...
    "West Godavari", "Alluri Sitharama Raju", "Anakapalli", "Bapatla", "Eluru", 
    "Kakinada", "Konaseema", "Nandyal", "NTR", "Palnadu", "Parvathipuram Manyam", 
  ...
  "Arunachal Pradesh": [
    ...
    "Lohit", "Namsai", "Changlang", "Tirap", "Longding", "Kamle", "Lepa Rada", "Shi Yomi"
  ],
  "Assam": [
  ...
  "Chhattisgarh": [
    ...
    "Manendragarh-Chirmiri-Bharatpur", "Mohla Manpur", "Mungeli", "Narayanpur", "Raigarh", 
  ...
  "Nagaland": [
    ...
    "Noklak", "Niuland", "Peren", "Phek", "Shamator", "Tseminyu", "Tuensang", "Wokha", "Zunheboto"
  ],
  "Odisha": [
  ...
  "Rajasthan": [
    ...
    "Kekri", "Khairthal Tijara", "Kota", "Kotputli Behror", "Nagaur", "Pali", 
  ...
  "Jammu and Kashmir": [
    ...
    "Kathua", "Kishtwar", "Kulgam", "Poonch", "Pulwama", "Rajouri", "Ramban", 
...
export function autoRecognizeDistrict(state: string, zipCode: string): string {
  const districts = STATE_DISTRICTS[state] || [];
  if (districts.length === 0) return "";
  let hash = 0;
  for (let i = 0; i < zipCode.length; i++) {
    hash = (hash * 31 + zipCode.charCodeAt(i)) % districts.length;
  }
  return districts[hash];
}
